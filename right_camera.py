...
globlist_right_camera = [[df['Правый голеностоп'].mean(), df['Правый голеностоп'].min(), df['Правый голеностоп'].max()],
                         [df['Правая коленка'].mean(), df['Правая коленка'].min(), df['Правая коленка'].max()],
                         [df['Правый тазобедренный сустав'].mean(), df['Правый тазобедренный сустав'].min(), df['Правый тазобедренный сустав'].max()]]
