...
globlist_left_camera = [[df['Левый голеностоп'].mean(), df['Левый голеностоп'].min(), df['Левый голеностоп'].max()],
                         [df['Левая коленка'].mean(), df['Левая коленка'].min(), df['Левая коленка'].max()],
                         [df['Левый тазобедренный сустав'].mean(), df['Левый тазобедренный сустав'].min(), df['Левый тазобедренный сустав'].max()]]
