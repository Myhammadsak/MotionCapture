...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    while cap.isOpened():
        ...
        res = cv2.resize(frame, (1200, 1000))
...
globlist_front_camera = [[df['Правый тазобедренный сустав'].mean(), df['Правый тазобедренный сустав'].min(), df['Правый тазобедренный сустав'].max()],
